...
void setup()
{
  ...
  //
  //Population
  pic1 = loadImage("../Image Used/Landscape/MW-IE203_corona_20200409232441_ZH.jpg");
  pic2 = loadImage("../Image Used/Landscape/kyG95j.jpg");
  pic3 = loadImage("../Image Used/Portrait/HD-wallpaper-gojo-cursed-spirits-domain-expansion-hollow-purple-jujutsu-kaisen-void.jpg");
  ...
  int picWidth1 = 890; //cat with mask
  int picHeight1 = 501;
  int picWidth2 = 863;//anakin vs obi-wan
  int picHeight2 = 520;
  int picWidth3 = 800; //jjk domain expantion
  int picHeight3 = 1000;
  //
